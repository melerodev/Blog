                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            ...
                            <span class="subheading">This blog is create with laravel but he doesn't work with the API of laravel, he just fetch to the database and build the nodes with JS</span>
                        </div>
                    </div>
                </div>
            </div>
